...
Microsoft offers a variety of Virtual Machines for testing legacy Internet Explorer versions on Windows 7 and 8, as well as Microsoft Edge on Windows 10. Vagrant uses VirtualBox, so it makes sense to grab the VirtualBox images.
